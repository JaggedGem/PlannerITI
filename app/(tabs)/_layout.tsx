      ...
      >
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, focused }) => (
              <AnimatedTabBarIcon focused={focused} color={color} name="calendar-month" />
            ),
        ...
        <Tabs.Screen
          ...
          options={{
            title: t('tabs').grades,
            tabBarIcon: ({ color, focused }) => (
              <AnimatedTabBarIcon focused={focused} color={color} name="school" />
            ),
        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, focused }) => (
              <AnimatedTabBarIcon focused={focused} color={color} name="assignment" />
            ),
        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, focused }) => (
              <AnimatedTabBarIcon focused={focused} color={color} name="settings" />
            ),
