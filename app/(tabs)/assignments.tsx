...
> {
  ...
  render() {
    if (this.state.hasError) {
      return <AssignmentsErrorFallback errorCount={this.state.errorCount} />;
    }
...
const styles = StyleSheet.create({
  ...
  dropdownItemPressed: {
    backgroundColor: ASSIGNMENTS_MODAL_COLORS.surface,
  },
  ...
  dropdownItemText: {
    fontSize: 17,
    color: ASSIGNMENTS_MODAL_COLORS.textSecondary,
  },
