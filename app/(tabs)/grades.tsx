    ...
    try {
        ...
        Object.entries(parsed).forEach(([key, value]) => {
            ...
            if (indices.length > 0 || hasExam) {
                normalized[key] = {
                    gradeIndices: Array.from(new Set(indices)).sort(
                        (a, b) => a - b,
                    ),
                    newExam: hasExam,
                };
        ...
        nextSemester.subjects.forEach((nextSubject) => {
            ...
            const examBecameAvailable =
                ...
                (prevSubject?.appliedExamGrade === undefined ||
                    prevSubject.appliedExamGrade !==
                        nextSubject.appliedExamGrade);
        ...
        >
            <View style={styles.idnpContent}>
                ...
                <TextInput
                    style={[
                        styles.idnpInput,
                        error ? styles.idnpInputError : null,
                    ]}
                    value={idnp}
                    onChangeText={(text) => {
                        ...
                        <View style={styles.averageSummaryRow}>
                            <View style={styles.averagePillPrimary}>
                                ...
                                {subject.appliedExamType &&
                                    typeof subject.appliedExamGrade ===
                                        'number' &&
                                    !isNaN(subject.appliedExamGrade) && (
                                        <Text style={styles.averagePillMeta}>
                                            ...
                                            •{' '}
                                            {subject.appliedExamGrade.toFixed(
                                                2,
                                            )}
                                        </Text>
                                    )}
                        ...
                        {subject.grades.map((grade, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isNewGrade && (
                                        <Text style={styles.gradePip}>*</Text>
                                    )}
                                </View>
                            );
                        })}
                                ...
                                <Animated.View
                                    ...
                                    style={[
                                        ...
                                        normalizedType === 'thesis' &&
                                            styles.examCardThesis,
                                        normalizedType === 'exam' &&
                                            styles.examCardExamVariant,
                                    ]}
                                >
                                        ...
                                        <View
                                            style={[
                                                ...
                                                normalizedType === 'other' &&
                                                    styles.examTypePillOther,
                                            ]}
                                        >
                                            <Text
                                                style={styles.examTypePillText}
                                            >
                                                {exam.type}
                                            </Text>
                                        </View>
                                        ...
                                        {!exam.isUpcoming ?
                                            <Text
                                                style={[
                                                    ...
                                                    normalizedType ===
                                                        'thesis' &&
                                                        styles.examGradeThesis,
                                                    normalizedType === 'exam' &&
                                                        styles.examGradeExam,
                                                ]}
                                            >
                                                {exam.grade}
                                            </Text>
                                        :   <Text
                                                style={styles.upcomingExamGrade}
                                            >
                                                TBD
                                            </Text>
                                        }
...
const findGradesToReachAverage = (
    ...
    const calculateReasonablenessScore = (
        grades: number[],
        avgDiff: number,
    ) => {
        ...
        const variance =
            grades.reduce((sum, g) => sum + Math.pow(g - avg, 2), 0) /
            grades.length;
    ...
    const backtrack = (
        ...
        if (newDifference < 0.01) {
            ...
            const score = calculateReasonablenessScore(
                newGrades,
                newDifference,
            );
...
const GradesScreen = ({
    ...
    const handleExportGradesPdf = useCallback(async () => {
        ...
        try {
            ...
            const impactedSubjects = allSubjects.filter(
                (subject: GradeSubject) =>
                    subject.appliedExamGrade !== undefined ||
                    !!subject.appliedExamType,
            ).length;
            const totalGrades = allSubjects.reduce(
                (sum: number, subject: GradeSubject) =>
                    sum + subject.grades.length,
                0,
            );
            const now = new Date();
      ...
      `;
            ...
            if (!sharingAvailable) {
                Alert.alert(
                    t('grades').pdf.shareTitle,
                    t('grades').pdf.shareMessage,
                );
                return;
            }
            ...
            Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
            Alert.alert(
                t('grades').pdf.errorTitle,
                t('grades').pdf.errorMessage,
            );
        } finally {
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
            ...
            <View
                style={[styles.headerContainer, refreshing && { opacity: 0.7 }]}
            >
                    ...
                    {studentGrades.currentGrades.map((semester, index) => (
                        ...
                        >
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    toggleSemester(semester.semester)
                                }
                                disabled={refreshing}
                            >
                                <Text
                                    style={[styles.semesterTitle, textOpacity]}
                                >
                                    ...
                                    {allSemestersAverages[index] && (
                                        ...
                                        >
                                            ...
                                            {semester.absences && (
                                                <View
                                                    style={
                                                        styles.absencesContainer
                                                    }
                                                >
                                                    <Text
                                                        style={[
                                                            styles.absencesLabel,
                                                            textOpacity,
                                                        ]}
                                                    >
                                                        {t('grades').absences}:{' '}
            ...
            {(isBackgroundRefreshing || backgroundJustUpdated) && (
                <View
                    style={styles.backgroundIndicatorWrapper}
                    pointerEvents="none"
                >
                    <View
                        style={[
                            ...
                            backgroundJustUpdated &&
                                styles.backgroundIndicatorUpdated,
                        ]}
                    >
                        {!backgroundJustUpdated ?
                            <View style={styles.dotsContainer}>
                                <Animated.View
                                    style={[styles.dot, dotStyle1]}
                                />
                                <Animated.View
                                    style={[styles.dot, dotStyle2]}
                                />
                                <Animated.View
                                    style={[styles.dot, dotStyle3]}
                                />
                            </View>
...
export default function Grades() {
    ...
    const persistHighlights = useCallback(
        async (
            targetIdnp: string | null,
            highlights: NewGradeHighlightsMap,
        ) => {
        ...
        const loadStoredData = async () => {
            try {
                ...
                if (savedIdnp) {
                    ...
                    setNewHighlights(
                        parseStoredHighlights(storedHighlightsRaw),
                    );
                    ...
                    if (!responseHtml) {
                        ...
                        const legacyJson =
                            await AsyncStorage.getItem(GRADES_DATA_KEY);
                        ...
                        const newCached =
                            await gradesDataService.getCached(savedIdnp);
                        ...
                        if (chosenHtml) {
                            ...
                            if (chosenTimestamp)
                                setLastUpdated(chosenTimestamp);
                        }
        ...
        <>
            {errorMessage && responseHtml && (
                ...
                >
                    ...
                    />
                    <Text style={styles.errorNotificationText}>
                        {errorMessage}
                    </Text>
                </Animated.View>
            )}
