...
const ModernDropdown = memo((props: ModernDropdownProps) => {
  ...
  }, [searchText, items, categories, tabs, onSearch]);
    ...
    return (
      <AnimatedTouchableOpacity
        ...
        style={[
          ...
          item.isCustomPeriod && {
            borderLeftWidth: 4,
            borderLeftColor: item.color || Colors.dark.primary,
          },
        ]}
    ...
    return (
      <>
        ...
        >
          ...
          {(searchPerTab || currentTab?.hasOwnSearchBar) && renderSearchBar()}
  ...
  const shouldScrollTabsContent = (): boolean => {
    if (!tabs || tabs.length === 0) {
      return false;
    }
