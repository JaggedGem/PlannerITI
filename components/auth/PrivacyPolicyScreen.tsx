...
import { Linking, Platform, ScrollView, StatusBar, StyleSheet, Text } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    padding: 16,
    paddingTop:
      Platform.OS === 'ios' ? 60 : StatusBar.currentHeight ? StatusBar.currentHeight + 16 : 16,
  },
  title: {
    fontSize: 24,
    fontWeight: 'bold',
