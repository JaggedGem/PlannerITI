      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity style={styles.forgotPassword} onPress={handleForgotPassword}>
            <ThemedText style={{ color: tintColor }}>{t('auth').login.forgotPassword}</ThemedText>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={[styles.skipButton]} onPress={handleSkip}>
            <ThemedText style={styles.skipButtonText}>{t('auth').optional.skip}</ThemedText>
          </TouchableOpacity>

          <View style={styles.footer}>
            <ThemedText>{t('auth').login.noAccount} </ThemedText>
            <TouchableOpacity onPress={() => router.replace('/signup')}>
              <ThemedText style={{ color: actionColor }}>{t('auth').login.signupLink}</ThemedText>
            </TouchableOpacity>
          </View>
        </View>
      </View>
