...
export function SignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      showCustomAlert(t('auth').signup.success, t('auth').verifyEmail.message);
    } catch {
        ...
        <View style={styles.form}>
          ...
          >
            <MaterialIcons
              ...
              color={actionColor}
            />
            <ThemedText style={styles.privacyText}>{t('auth').signup.privacyAccept}</ThemedText>
          </TouchableOpacity>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity onPress={() => router.replace('/auth')}>
              <ThemedText style={{ color: actionColor }}>{t('auth').signup.loginLink}</ThemedText>
            </TouchableOpacity>
          </View>
        </View>
      </View>
